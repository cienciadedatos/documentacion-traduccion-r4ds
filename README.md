...
* En el archivo __orientaciones para la revisión__ (en desarrollo) se entregan recomendaciones sobre los aspectos en los que es necesario fijarse al momeno de revisar una traducción y el tipo de lenguaje a utilizar para hacer recomendaciones. 
* En el archivo __distribución de roles__ (en desarrollo) se explicitan las responsabilidades de las personas que participan en este proyecto y la asignación de capítulos para traducir y revisar. 
